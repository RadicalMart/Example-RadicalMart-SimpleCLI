...
use Joomla\Plugin\RadicalMart\SimpleCLI\Extension\SimpleCLI;
	...
	public function register(Container $container)
	{
		...
		$container->set(PluginInterface::class,
			function (Container $container) {
				...
				$config  = (array) PluginHelper::getPlugin('radicalmart', 'simple_cli');
				$plugin  = new SimpleCLI($subject, $config);
